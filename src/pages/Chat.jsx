...
const Chat = () => {
  const [contacts, setContacts] = useState([
    {
      ...
      online: true,
      lastMessage: 'Let us resume the quantum calculus session tomorrow.',
      time: '10:42 AM',
      unread: 2,
    },
    {
  ...
  const [messagesMap, setMessagesMap] = useState({
    1: [
      { id: 101, sender: 'them', text: 'Hello Rafay! How is your progress on differential equations?', time: '10:30 AM' },
      { id: 102, sender: 'me', text: 'Hi Dr. Sarah! I completed the exercise set, but had a doubt on second-order ODEs.', time: '10:35 AM' },
      { id: 103, sender: 'them', text: 'Let us resume the quantum calculus session tomorrow.', time: '10:42 AM' }
    ],
    2: [
      { id: 201, sender: 'them', text: 'I have uploaded the assignment feedback.', time: 'Yesterday' }
    ],
    3: [
      { id: 301, sender: 'them', text: 'Can you share the notes for vector spaces?', time: '2 days ago' }
    ]
  });
    ...
    <div className="flex h-screen bg-slate-50/60 font-sans text-slate-800 overflow-hidden selection:bg-slate-900 selection:text-white">
      ...
      <main className="flex-1 flex overflow-hidden w-full p-0 md:p-4 gap-4">
        ...
        <div className={`flex-1 flex flex-col h-full bg-white md:rounded-3xl border border-slate-200/80 shadow-xs overflow-hidden w-full ${
          ...
          {/* Header */}
          <header className="px-5 py-4 border-b border-slate-100 flex items-center justify-between shrink-0 bg-white/80 backdrop-blur-md">
