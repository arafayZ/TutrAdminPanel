...
const CustomDropdown = ({ label, value, onChange, options }) => {
  ...
  return (
    <div className="flex items-center gap-1.5 sm:gap-2 relative w-full sm:w-auto" ref={dropdownRef}>
      {label && <span className="text-[10px] uppercase font-bold text-gray-400 shrink-0">{label}:</span>}
...
const TutorManagement = () => {
  ...
  return (
    <div className="flex h-screen bg-[#F8F9FB] font-sans text-gray-900 overflow-hidden relative">
        ...
        {viewState === 'notifications' ? (
          ...
          <div className="p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto w-full space-y-4 sm:space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 tracking-tight">Tutor Management</h2>
                <p className="text-xs text-gray-500 mt-0.5 sm:mt-1">Oversee, verify, and monitor educational professional performance.</p>
              </div>
              <button
            ...
            <div className="bg-white p-3 rounded-2xl border border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
              ...
              <div className="text-gray-400 text-[11px] sm:text-xs font-medium shrink-0 pt-1 sm:pt-0 border-t sm:border-t-0 border-gray-50">
      ...
      {selectedTutor && (
        <aside className="w-full sm:w-96 bg-white border-l border-gray-200 h-screen overflow-y-auto flex flex-col justify-between p-6 shadow-xl z-20 fixed sm:sticky right-0 top-0">
